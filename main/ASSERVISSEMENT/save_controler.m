function save_controler(controler, base_file_name,  folder_name)
%% Enregistre le modèle dans un sous dossier

% Rend l'argument base_file_name facultatif
if nargin < 3
    folder_name = "Identified_controler"; % Valeur par défaut pour b
end

if nargin < 2
    base_file_name = "controler"; % Valeur par défaut pour c
end
