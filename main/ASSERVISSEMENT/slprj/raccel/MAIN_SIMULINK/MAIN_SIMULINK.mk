###########################################################################
## Makefile generated for component 'MAIN_SIMULINK'. 
## 
## Makefile     : MAIN_SIMULINK.mk
## Generated on : Thu Mar 20 00:13:50 2025
## Final product: ./MAIN_SIMULINK.exe
...
PRODUCT_NAME              = MAIN_SIMULINK
MAKEFILE                  = MAIN_SIMULINK.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/Mathieu/ONEDRI~1/0_Ulaval/SESSIO~4/MODLIS~1/Prog/Design2/main/ASSERV~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = MAIN_SIMULINK_comp.rsp
CMD_FILE                  = MAIN_SIMULINK.rsp
...
DEFINES_STANDARD = -DMODEL=MAIN_SIMULINK -DNUMST=5 -DNCSTATES=6 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/MAIN_SIMULINK/MAIN_SIMULINK.c $(START_DIR)/slprj/raccel/MAIN_SIMULINK/MAIN_SIMULINK_capi.c $(START_DIR)/slprj/raccel/MAIN_SIMULINK/MAIN_SIMULINK_data.c $(START_DIR)/slprj/raccel/MAIN_SIMULINK/MAIN_SIMULINK_tgtconn.c $(START_DIR)/slprj/raccel/MAIN_SIMULINK/rtGetInf.c $(START_DIR)/slprj/raccel/MAIN_SIMULINK/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = MAIN_SIMULINK.obj MAIN_SIMULINK_capi.obj MAIN_SIMULINK_data.obj MAIN_SIMULINK_tgtconn.obj rtGetInf.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/MAIN_SIMULINK/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/MAIN_SIMULINK/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/MAIN_SIMULINK/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/MAIN_SIMULINK/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/MAIN_SIMULINK/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MAIN_SIMULINK.obj : $(START_DIR)/slprj/raccel/MAIN_SIMULINK/MAIN_SIMULINK.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MAIN_SIMULINK_capi.obj : $(START_DIR)/slprj/raccel/MAIN_SIMULINK/MAIN_SIMULINK_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MAIN_SIMULINK_data.obj : $(START_DIR)/slprj/raccel/MAIN_SIMULINK/MAIN_SIMULINK_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MAIN_SIMULINK_tgtconn.obj : $(START_DIR)/slprj/raccel/MAIN_SIMULINK/MAIN_SIMULINK_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/raccel/MAIN_SIMULINK/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/MAIN_SIMULINK/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
