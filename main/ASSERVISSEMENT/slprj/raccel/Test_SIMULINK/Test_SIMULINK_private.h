#ifndef Test_SIMULINK_private_h_
#define Test_SIMULINK_private_h_
#include "rtwtypes.h"
...
extern void ku2qn2adnt ( ktdbkejzpq * localDW ) ; extern void jsizzi1xto ( real_T kpnefwksgf , mtm33kqezg * localB , ktdbkejzpq * localDW ) ;
