###########################################################################
## Makefile generated for component 'Test_SIMULINK'. 
## 
## Makefile     : Test_SIMULINK.mk
## Generated on : Thu Mar 20 01:21:26 2025
## Final product: ./Test_SIMULINK.exe
...
COMPILER_COMMAND_FILE     = Test_SIMULINK_comp.rsp
CMD_FILE                  = Test_SIMULINK.rsp
...
DEFINES_STANDARD = -DMODEL=Test_SIMULINK -DNUMST=4 -DNCSTATES=5 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/Test_SIMULINK/Test_SIMULINK.c $(START_DIR)/slprj/raccel/Test_SIMULINK/Test_SIMULINK_capi.c $(START_DIR)/slprj/raccel/Test_SIMULINK/Test_SIMULINK_data.c $(START_DIR)/slprj/raccel/Test_SIMULINK/Test_SIMULINK_tgtconn.c $(START_DIR)/slprj/raccel/Test_SIMULINK/rtGetInf.c $(START_DIR)/slprj/raccel/Test_SIMULINK/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = Test_SIMULINK.obj Test_SIMULINK_capi.obj Test_SIMULINK_data.obj Test_SIMULINK_tgtconn.obj rtGetInf.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/Test_SIMULINK/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/Test_SIMULINK/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/Test_SIMULINK/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/Test_SIMULINK/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/Test_SIMULINK/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Test_SIMULINK.obj : $(START_DIR)/slprj/raccel/Test_SIMULINK/Test_SIMULINK.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Test_SIMULINK_capi.obj : $(START_DIR)/slprj/raccel/Test_SIMULINK/Test_SIMULINK_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Test_SIMULINK_data.obj : $(START_DIR)/slprj/raccel/Test_SIMULINK/Test_SIMULINK_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Test_SIMULINK_tgtconn.obj : $(START_DIR)/slprj/raccel/Test_SIMULINK/Test_SIMULINK_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/raccel/Test_SIMULINK/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/Test_SIMULINK/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
