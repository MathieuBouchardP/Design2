...
## Generated on : Thu Mar 20 01:24:15 2025
## Final product: ./MAIN_SIMULINK_acc.lib
...
%.obj : $(START_DIR)/slprj/accel/MAIN_SIMULINK/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/MAIN_SIMULINK/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/MAIN_SIMULINK/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/MAIN_SIMULINK/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/MAIN_SIMULINK/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
