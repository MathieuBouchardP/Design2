...
## Generated on : Wed Mar 19 23:43:01 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/MAIN_SIMULINK_acc.mexw64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/MAIN_SIMULINK_acc.mexw64
...
DEFINES_STANDARD = -DMODEL=MAIN_SIMULINK -DNUMST=4 -DNCSTATES=6 -DHAVESTDIO -DMDL_REF_SIM_TGT=1
...
SRCS = $(START_DIR)/slprj/accel/MAIN_SIMULINK/MAIN_SIMULINK_acc.c $(START_DIR)/slprj/accel/MAIN_SIMULINK/MAIN_SIMULINK_acc_data.c $(START_DIR)/slprj/accel/MAIN_SIMULINK/rtGetInf.c $(START_DIR)/slprj/accel/MAIN_SIMULINK/rt_nonfinite.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = MAIN_SIMULINK_acc.obj MAIN_SIMULINK_acc_data.obj rtGetInf.obj rt_nonfinite.obj c_mexapi_version.obj
...
MAIN_SIMULINK_acc.obj : $(START_DIR)/slprj/accel/MAIN_SIMULINK/MAIN_SIMULINK_acc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MAIN_SIMULINK_acc_data.obj : $(START_DIR)/slprj/accel/MAIN_SIMULINK/MAIN_SIMULINK_acc_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/accel/MAIN_SIMULINK/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/accel/MAIN_SIMULINK/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
