...
## Generated on : Thu Mar 20 01:20:49 2025
## Final product: ./Test_SIMULINK_acc.lib
...
%.obj : $(START_DIR)/slprj/accel/Test_SIMULINK/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/Test_SIMULINK/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/Test_SIMULINK/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/Test_SIMULINK/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/Test_SIMULINK/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
